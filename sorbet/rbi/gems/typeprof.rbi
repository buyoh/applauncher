...
class TypeProf::ConfigData < Struct
  ...
  def gem_repo_dirs; end
  def gem_repo_dirs=(_); end
...
class TypeProf::ISeqBlock < TypeProf::Block
  def consistent?(other); end
  def do_call(aargs, caller_ep, caller_env, scratch, replace_recv_ty:, &ctn); end
...
class TypeProf::ISeq
  ...
  def self.new(*args); end
  def setup_iseq(insns, special_labels); end
...
class TypeProf::Scratch
  ...
  def add_constant(klass, name, value, user_defined); end
  ...
  def do_invoke_block(blk, aargs, ep, env, replace_recv_ty: nil, &ctn); end
  def do_send(recv, mid, aargs, ep, env, &ctn); end
  ...
  def get_ivar(recv); end
  def get_method(klass, singleton, mid); end
  ...
  def new_class(cbase, name, type_params, superclass, absolute_path); end
...
class TypeProf::Scratch::ClassDef
  ...
  def initialize(kind, name, absolute_path); end
  def ivars; end
  def kind; end
  def klass_obj; end
...
class TypeProf::Import
  ...
  def self.import_rbs_file(scratch, rbs_path); end
end
