...
class RBS::AST::Members::MethodDefinition < RBS::AST::Members::Base
  ...
  def to_json(*a); end
  def types; end
  def update(name: nil, kind: nil, types: nil, annotations: nil, location: nil, comment: nil, overload: nil); end
end
...
class RBS::Parser < Racc::Parser
  ...
  def new_token(type, value = nil); end
  def next_token; end
  def on_error(token_id, error_value, value_stack); end
  def push_comment(string, location); end
  def reset_variable_scope; end
  def self.parse_method_type(input, variables: nil, eof_re: nil); end
  def self.parse_signature(input, eof_re: nil); end
  def self.parse_type(input, variables: nil, eof_re: nil); end
...
class RBS::Parser::SyntaxError < StandardError
  def error_value; end
  def initialize(token_str:, error_value:, value_stack: nil); end
  def token_str; end
  def value_stack; end
end
class RBS::Parser::SemanticsError < StandardError
